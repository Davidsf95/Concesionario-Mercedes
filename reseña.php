...
<body>
    <div class="reseña">
        ...
        <form method="post" action="procesar_reseña.php">
            ...
            <label for="valoracion"><b>Comparte aquí tu experiencia sobre el servicio recibido en el concesionario:</b></label>
            <textarea id="valoracion" name="valoracion" rows="5" required></textarea>
